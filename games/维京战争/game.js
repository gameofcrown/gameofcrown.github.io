...
(function (b, c) {
    ...
    $.ajax({
        url: "/game/search", async: false, success: function () {
            Bb = function (b, c, d) {
                var p, e = 0,
                    q = Ba.length,
    ...
    ig.Input.inject({
        keydown: function (c) {
            ...
            if (!("INPUT" == e || "TEXTAREA" == e))
                if (e = "keydown" == c.type ? c.keyCode : 2 == c.button ? ig.KEY.MOUSE2 : ig.KEY.MOUSE1, b && 0 > e && window.focus(), ("touchstart" == c.type || "mousedown" == c.type) && this.mousemove(c), e = this.bindings[e]) 
                {
                    this.actions[e] = !0, this.locks[e] || (this.presses[e] = !0, this.locks[e] = !0), c.stopPropagation(), c.preventDefault()
                }
        }
    })
});
...
ig.module("game.entities.buttons.button-battle").requires("game.entities.buttons.button").defines(function () {
    EntityButtonBattle = EntityButton.extend({
        ...
        clicked: function () {//#CLOWREAD!!!! TODO 
            parent.action_transfer("eosio.token", parent.GLOBAL_DATA.username ,"gigaofcolony","1.0000 EOS","STARDUSTREG$000001");
...
ig.module("game.entities.buttons.button-oke").requires("game.entities.buttons.button").defines(function () {
    EntityButtonOke = EntityButton.extend({
        ...
        clicked: function () {//@@CLOWREAD TODO
            parent.action_transfer_callback("eosio.token", parent.GLOBAL_DATA.username ,"gigaofcolony","0.0001 EOS","STARDUSTRND$"+0,function (){reinit();}   );
        },
        clicking: function () { },
        released: function () { },
        moveBtn: function () {
